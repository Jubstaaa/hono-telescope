import { IncomingRequestEntry, OutgoingRequestEntry, ExceptionEntry, LogEntry, QueryEntry } from './entries';
...
export type TelescopeListResponse = IncomingRequestResponse | OutgoingRequestResponse | ExceptionResponse | LogResponse | QueryResponse;
...
export type TelescopeDetailResponse = IncomingRequestDetailResponse | OutgoingRequestDetailResponse | ExceptionDetailResponse | LogDetailResponse | QueryDetailResponse;
