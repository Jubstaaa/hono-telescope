...
export type TelescopeEntry = IncomingRequestEntry | OutgoingRequestEntry | ExceptionEntry | LogEntry | QueryEntry;
export type TelescopeCreateInput = IncomingRequestCreateInput | OutgoingRequestCreateInput | ExceptionCreateInput | LogCreateInput | QueryCreateInput;
